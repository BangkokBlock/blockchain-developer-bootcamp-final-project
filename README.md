...
(8)In the same terminal (second terminal)… npm run dev then copy and paste the provided webpage (http://localhost:3000/)into your webbrowser. Please use Chrome. 
